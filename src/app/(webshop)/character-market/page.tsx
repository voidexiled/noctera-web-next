...
import type { character_market } from "@prisma/client";
...
const getCharacterMarket = async ({
	currentPage,
	vocation,
	search,
}: { search: string; vocation: string; currentPage: number }) => {
...
export default async function CharacterMarket({
	searchParams,
}: { searchParams?: { search?: string; vocation?: string; page?: string } }) {
			...
			<Card>
				...
				<CardContent className="space-y-2 p-2">
					...
					<div className="rounded border">
						<div>
							<div className="grid gap-2 border-b p-2 sm:grid-cols-2">
