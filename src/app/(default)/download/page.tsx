						...
						<TabsContent value="otClient">
							<div className="mb-2 grid grid-cols-2 gap-2">
								<div className="rounded-sm border shadow-md">
									...
									<div className="flex h-[120px] flex-col items-center justify-center ">
										<IconiFy icon={"line-md:cloud-download-loop"} className="h-10 w-10" />
										<Link
							...
							<div className="flex flex-col rounded-sm border">
								...
								<div className="p-2">
									<ul className="my-1 ml-6 list-disc font-medium text-xs [&>li]:mt-2">
										...
										<li>
											Gráficos: 128MB; se DirectX 9c ou OpenGL 2.1 não são suportados, apenas o modo
											renderizador de software está disponível (sem efeitos de luz)
										</li>
							...
							<div className="mt-2 flex flex-col space-y-2 rounded-md border p-2 leading-none">
								...
								<p className="text-xs">
									...
									warranty of any kind. The entire risk arising out of use of the software remains
									with you. In no event shall CipSoft GmbH be liable for any damages to your
