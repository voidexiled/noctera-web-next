			...
			<CardContent className="space-y-2 px-0">
				<ScrollArea>
					...
					<div className="px-4 py-3">
						<Tabs defaultValue="server_info" className="w-full overflow-auto">
                      ...
                      <TableCell>IP AQUI</TableCell>
											...
											<TableRow>
												...
												<TableCell>
													<span>Green: 2 stamina each 3 minutes</span>
													<br />
													<span>Orange: 2 stamina each 5 minutes</span>
												</TableCell>
											</TableRow>
										</TableBody>
									</Table>
								...
								<div className="flex flex-col rounded-sm border">
									...
									<Table className="text-center">
										<TableBody>
											<TableRow>
												<TableCell>
													<b>from 2 to 5 players with different vocations</b>
												</TableCell>
