				...
				<DropdownMenuGroup>
					<Dialog>
						<DialogTrigger asChild>
							<DropdownMenuItem onSelect={(e) => e.preventDefault()}>Informations</DropdownMenuItem>
						</DialogTrigger>
						<DialogContent>
							<DialogHeader>
					...
					<Dialog>
						<DialogTrigger asChild>
							<DropdownMenuItem onSelect={(e) => e.preventDefault()}>Add Coins</DropdownMenuItem>
						</DialogTrigger>
						<DialogContent>
							<DialogHeader>
					...
					<Dialog>
						<DialogTrigger asChild>
							<DropdownMenuItem onSelect={(e) => e.preventDefault()}>Add Premium</DropdownMenuItem>
						</DialogTrigger>
						<DialogContent>
							<DialogHeader>
