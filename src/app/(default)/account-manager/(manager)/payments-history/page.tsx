...
import { CancelOrderButton } from "@/components/(account-manager)/(manager)/manager/payments-history/CancelOrderButton";
import { CompleteOrderButton } from "@/components/(account-manager)/(manager)/manager/payments-history/CompleteOrderButton";
