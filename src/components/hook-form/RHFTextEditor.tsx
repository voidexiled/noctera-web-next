				...
				<div className="grid gap-2">
					<Editor
						...
						init={{
							...
							toolbar:
								"undo redo preview | aidialog aishortcuts | blocks fontsizeinput | bold italic strikethrough | align numlist bullist | link image | table media pageembed | lineheight  outdent indent | forecolor backcolor formatpainter removeformat | charmap emoticons checklist | code fullscreen  | pagebreak anchor codesample footnotes mergetags | addtemplate inserttemplate | addcomment showcomments | ltr rtl casechange | spellcheckdialog a11ycheck",
