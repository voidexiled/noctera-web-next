...
export const BattlepassRewardVip = ({ battlepassLevel }: BattlepassRewardVipType) => {
	...
	}, [battlepassLevel.rewards, selectedPlayer.player_battlepass_rewards_claimed]);
	...
	return (
		...
		>
			<img
				alt="locked reward"
				className={cn("absolute top-[5px] right-[5px] hidden", (isLocked || !hasAccess) && "flex ")}
				width={20}
				height={29}
			...
			>
				...
				<div className="relative flex flex-col items-center justify-start">
					{battlepassLevel.rewards
						.sort(
							(a, b) =>
								RANK_PRIORITY[a.reward_required_access as BATTLEPASS_RANK_ACCESS] -
